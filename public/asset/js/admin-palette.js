...
(function () {
  ...
  // Note : pas d'emojis — initiale de la catégorie en lieu et place,
  // pour rester cohérent avec la typographie sobre du site.
  const COMMANDS = [
    { id: 'new-sortie',    label: 'Nouvelle sortie',            icon: 'S', kw: 'sortie ajouter creer add new course parcours',
      action: () => { location.href = '/admin.html#tab-sorties&new'; } },
    { id: 'new-evenement', label: 'Nouvel événement',           icon: 'E', kw: 'evenement ajouter creer event new',
      action: () => { location.href = '/admin.html#tab-evenements&new'; } },
    { id: 'new-membre',    label: 'Nouveau membre',             icon: 'M', kw: 'membre user ajouter creer add invite',
      action: () => { location.href = '/admin.html#tab-membres&new'; } },
    { id: 'broadcast',     label: 'Broadcast email',            icon: 'B', kw: 'broadcast email mail envoi communique',
    ...
    { id: 'maintenance',   label: 'Toggle mode maintenance',    icon: '·', kw: 'maintenance mode bloque offline',
      action: () => { location.href = '/admin.html#tab-outils'; } },
    { id: 'audit-log',     label: 'Audit log',                  icon: 'A', kw: 'audit log trace historique journal',
    ...
    { id: 'newsletter',    label: 'Voir abonnés newsletter',    icon: 'N', kw: 'newsletter abonnes mailing list',
      action: () => { location.href = '/admin.html#tab-newsletter'; } },
    { id: 'dashboard',     label: 'Dashboard live',             icon: 'D', kw: 'dashboard stats live home admin',
      action: () => { location.href = '/admin.html#tab-dashboard'; } },
    { id: 'photos',        label: 'Galerie photos',             icon: 'P', kw: 'photos galerie images upload',
      action: () => { location.href = '/admin.html#tab-photos'; } },
    { id: 'palmares',      label: 'Gérer palmarès',             icon: 'P', kw: 'palmares medaille victoire course',
      action: () => { location.href = '/admin.html#tab-palmares'; } },
    { id: 'segments',      label: 'Gérer segments',             icon: 'K', kw: 'segments kom strava chrono',
      action: () => { location.href = '/admin.html#tab-segments'; } },
    { id: 'contacts',      label: 'Messages de contact',        icon: 'C', kw: 'contact message support formulaire',
    ...
    { id: 'theme-toggle',  label: 'Changer de thème',           icon: 'T', kw: 'theme dark light sombre clair mode',
