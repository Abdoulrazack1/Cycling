...
const POIS_MAP = {
  'arenberg-2025-04-05': [
    ...
    { id: 'pr-7',  type: 'secteur',   label: "Secteur — Trouée d'Arenberg",  desc: '2400 m · 5 étoiles',             km: 95.8,  lat: 50.4186, lng: 3.2553 },
    { id: 'pr-10', type: 'arrivee',   label: 'Arrivée — Vélodrome de Roubaix', desc: 'Vélodrome André-Pétrieux',     km: 172.0, lat: 50.6922, lng: 3.1572 },
  ],
...
const EVENEMENTS = [
  { slug: 'saloueloise-2025', title: 'La Saloueloise Pavés', type: 'cyclosportive', date: '2025-04-13', heure: '08:30', lieu: 'Salouel', region: 'Hauts-de-France', distance_km: 172, inscrits: 284, max_inscrits: 400, engagement_eur: 18, sortie_id: 'arenberg-2025-04-05', statut: 'ouvert', hero_img: 'https://images.unsplash.com/photo-1517649763962-0c623066013b?w=1400&q=85', description: 'Notre cyclosportive annuelle sur les pavés. Trois parcours au choix — 65, 115 ou 172 km en tracé Paris-Roubaix intégral.' },
