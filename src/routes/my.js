/* ═════════════════════════════════════════════════════════════════
   ...
   ─────────────────────────────────────────────────────────────────
   GET  /api/my/dashboard        agrege favoris + inscriptions + recently viewed
   GET  /api/my/inscriptions     liste de toutes les inscriptions
   GET  /api/my/recent           dernieres sorties consultees
...
router.get('/inscriptions', requireAuth, async (req, res) => {
  try {
...
router.post('/recent/:sortieId', requireAuth, async (req, res) => {
