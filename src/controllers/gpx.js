/* controllers/gpx.js — Upload + listing + service des fichiers GPX */
const path = require('path');
const fs   = require('fs');
const { query } = require('../config/database');
const { GPX_DIR } = require('../middleware/upload');

// POST /api/gpx/upload (après multer + validation dans la route)
